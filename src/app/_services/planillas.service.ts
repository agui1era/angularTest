...
export class PlanillasService {
  ...
  getPlanillaProduccion(data) {
    return this.http.get<any>(`${environment.apiUrl}/${this.entityPathName}/produccion?dia=${data}`);

    /* return this.http.post<any[]>(`${environment.apiUrl}/${this.entityPathName}/produccion`, data, {
      headers: {
