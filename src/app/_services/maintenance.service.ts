...
export class MaintenanceService {
  ...
  init(id) {
    return this.http.get<any[]>(`${environment.apiUrl}/${this.entityPathName}/init/${id}`);
  }
  ...
  dscto(data) {
    return this.http.patch<any>(`${environment.apiUrl}/${this.entityPathName}/dscto`, data, {
      headers: {
        "content-type": "application/json"
      }
    });
