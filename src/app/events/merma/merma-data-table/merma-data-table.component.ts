...
@Component({
  selector: 'app-merma-data-table',
  templateUrl: './merma-data-table.component.html',
  styleUrls: ['./merma-data-table.component.sass']
})
export class MermaDataTableComponent implements OnInit {
